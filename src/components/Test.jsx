export default function Test() {
    return (
        <div className="p-4 mx-auto lg:max-w-6xl md:max-w-3xl">
                    ...
                    <div className="p-2 flex-1 flex flex-col">
                        <div className="flex-1">
                            <a
                                ...
                                className="block border-0 outline-0"
                            >
                        ...
                        <div className="flex items-center gap-2 mt-4">
                            ...
                            <button
                                type="button"
                                className="text-sm font-medium px-2 cursor-pointer min-h-[36px] w-full bg-blue-600 hover:bg-blue-700 text-white tracking-wide ml-auto outline-0 border-0 rounded-sm"
                            >
                                Add to cart
                            </button>
                        </div>
                ...
                <div className="bg-white flex flex-col overflow-hidden hover:shadow-md transition-all">
                    ...
                    <div className="p-2 flex-1 flex flex-col">
                        <div className="flex-1">
                            ...
                            >
                                <h5 className="text-sm sm:text-base font-semibold text-slate-900 truncate">
                                    Emerald Empress Gown
                                </h5>
                            </a>
                            <p className="text-sm mt-1 text-slate-600 truncate">
                                Regal, cape-style green outfit
                            </p>
                            <div className="flex flex-wrap justify-between gap-2 mt-3">
                                <div className="flex gap-2">
                                    <h6 className="text-sm sm:text-base font-bold text-slate-900">
                ...
                <div className="bg-white flex flex-col overflow-hidden hover:shadow-md transition-all">
                    ...
                    <div className="p-2 flex-1 flex flex-col">
                        <div className="flex-1">
                            ...
                            <p className="text-sm mt-1 text-slate-600 truncate">
                                Sleek black leather and white tee combo
                            </p>
                            <div className="flex flex-wrap justify-between gap-2 mt-3">
                                <div className="flex gap-2">
                                    <h6 className="text-sm sm:text-base font-bold text-slate-900">
                ...
                <div className="bg-white flex flex-col overflow-hidden hover:shadow-md transition-all">
                    ...
                    <div className="p-2 flex-1 flex flex-col">
                        <div className="flex-1">
                            ...
                            >
                                <h5 className="text-sm sm:text-base font-semibold text-slate-900 truncate">
                                    Street Luxe Knit Set
                                </h5>
                            </a>
                            <p className="text-sm mt-1 text-slate-600 truncate">
                                Casual streetwear with a stylish knit top
                            </p>
                            <div className="flex flex-wrap justify-between gap-2 mt-3">
                                <div className="flex gap-2">
                                    <h6 className="text-sm sm:text-base font-bold text-slate-900">
                ...
                <div className="bg-white flex flex-col overflow-hidden hover:shadow-md transition-all">
                    ...
                    <div className="p-2 flex-1 flex flex-col">
                        <div className="flex-1">
                            ...
                            >
                                <h5 className="text-sm sm:text-base font-semibold text-slate-900 truncate">
                                    Bold Stroll Coat Set
                                </h5>
                            </a>
                            <p className="text-sm mt-1 text-slate-600 truncate">
                                Statement black coat with red print trousers
                            </p>
                            <div className="flex flex-wrap justify-between gap-2 mt-3">
                                <div className="flex gap-2">
                                    <h6 className="text-sm sm:text-base font-bold text-slate-900">
                ...
                <div className="bg-white flex flex-col overflow-hidden hover:shadow-md transition-all">
                    ...
                    <div className="p-2 flex-1 flex flex-col">
                        <div className="flex-1">
                            ...
                            >
                                <h5 className="text-sm sm:text-base font-semibold text-slate-900 truncate">
                                    Floral Blush Midi Dress
                                </h5>
                            </a>
                            <p className="text-sm mt-1 text-slate-600 truncate">
                                Soft, romantic floral dress
                            </p>
                            <div className="flex flex-wrap justify-between gap-2 mt-3">
                                <div className="flex gap-2">
                                    <h6 className="text-sm sm:text-base font-bold text-slate-900">
                ...
                <div className="bg-white flex flex-col overflow-hidden hover:shadow-md transition-all">
                    ...
                    <div className="p-2 flex-1 flex flex-col">
                        <div className="flex-1">
                            ...
                            >
                                <h5 className="text-sm sm:text-base font-semibold text-slate-900 truncate">
                                    Chic Contrast Blazer Fit
                                </h5>
                            </a>
                            <p className="text-sm mt-1 text-slate-600 truncate">
                                Trendy blazer and denim street style
                            </p>
                            <div className="flex flex-wrap justify-between gap-2 mt-3">
                                <div className="flex gap-2">
                                    <h6 className="text-sm sm:text-base font-bold text-slate-900">
                ...
                <div className="bg-white flex flex-col overflow-hidden hover:shadow-md transition-all">
                    ...
                    <div className="p-2 flex-1 flex flex-col">
                        <div className="flex-1">
                            ...
                            >
                                <h5 className="text-sm sm:text-base font-semibold text-slate-900 truncate">
                                    Effortless Café Casuals
                                </h5>
                            </a>
                            <p className="text-sm mt-1 text-slate-600 truncate">
                                Relaxed tank top and jeans outfit
                            </p>
                            <div className="flex flex-wrap justify-between gap-2 mt-3">
                                <div className="flex gap-2">
                                    <h6 className="text-sm sm:text-base font-bold text-slate-900">
